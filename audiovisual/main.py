...
def test_adam(args, use_gpu):
    if args.every_frame and args.mode != 'temporalConv':
        save_path = '/mnt/hdd2/alvanaki/audiovisual_trained/' + args.mode + '_every_frame'
    elif not args.every_frame and args.mode != 'temporalConv':
        save_path = '/mnt/hdd2/alvanaki/audiovisual_trained/' + args.mode + '_last_frame'
    elif args.mode == 'temporalConv':
        save_path = '/mnt/hdd2/alvanaki/audiovisual_trained/' + args.mode
    else:
...
def main():
    ...
    parser.add_argument('--audio-path', default='/mnt/hdd2/alvanaki/trained_audio/finetuneGRU_every_frame/finetuneGRU_4.pt', help='path to pre-trained audio model')
    parser.add_argument('--video-path', default='/home/evialv/Documents/audiovisual/Video_only_model.pt', help='path to pre-trained video model')
    parser.add_argument('--concat-path', default='', help='path to pre-trained concat model')
    parser.add_argument('--audio-dataset', default='/mnt/hdd2/alvanaki/audio_dataset_full', help='path to audio dataset')
    parser.add_argument('--video-dataset', default='/mnt/hdd2/alvanaki/video_dataset', help='path to video dataset')
    ...
    parser.add_argument('--batch-size', default=36, type=int, help='mini-batch size (default: 18)')
    parser.add_argument('--workers', default=4, type=int, help='number of data loading workers (default: 4)')
    parser.add_argument('--epochs', default=5, type=int, help='number of total epochs')

...
def test_adam(args, use_gpu):
    if args.every_frame and args.mode != 'temporalConv':
        save_path = '/mnt/hdd2/alvanaki/trained_models/' + args.mode + '_every_frame'
    elif not args.every_frame and args.mode != 'temporalConv':
        save_path = '/mnt/hdd2/alvanaki/trained_models/' + args.mode + '_last_frame'
    elif args.mode == 'temporalConv':
        save_path = '/mnt/hdd2/alvanaki/trained_models/' + args.mode
    else:
...
def main():
    ...
    parser.add_argument('--path', default='/mnt/hdd2/alvanaki/trained_models/temporalConv/temporalConv_1.pt', help='path to model')
    parser.add_argument('--dataset', default=r'/mnt/hdd2/alvanaki/video_dataset', help='path to dataset')

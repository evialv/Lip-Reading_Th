...
def main():
    ...
    parser.add_argument('--path', default='/mnt/hdd2/alvanaki/trained_audio/finetuneGRU_every_frame/finetuneGRU_4.pt', help='path to model')
    ...
    parser.add_argument('--lr', default=0.0001723047532495552, type=float, help='initial learning rate')#default=0.0003
    parser.add_argument('--batch-size', default=36, type=int, help='mini-batch size (default: 36)')
    parser.add_argument('--workers', default=4, type=int, help='number of data loading workers (default: 4)')
    parser.add_argument('--epochs', default=4, type=int, help='number of total epochs')

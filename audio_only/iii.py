...
class MyDataset(object):
    def __init__(self,  folds, data_dir, label_fp, annonation_direc=None,
    ...
    def load_dataset(self):
        ...
        print('Partition {} loaded'.format(self.folds))
    ...
    def _get_files_for_partition(self):
        ...
        search_str_npz = os.path.join(dir_fp, '*', self.folds, '*.npz')
        search_str_npy = os.path.join(dir_fp, '*', self.folds, '*.npy')
        search_str_mp4 = os.path.join(dir_fp, '*', self.folds, '*.mp4')
